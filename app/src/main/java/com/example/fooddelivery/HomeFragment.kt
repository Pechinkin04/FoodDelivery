...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        listPopular.add(PopularModel(R.drawable.pop_menu_burger,"Сэндвич", 150, 150, 1))
        listPopular.add(PopularModel(R.drawable.pop_menu_sandwich, "Момо",200,200, 1))
        listPopular.add(PopularModel(R.drawable.pop_menu_momo,"Бургер",175,175, 1))
        listPopular.add(PopularModel(R.drawable.pop_menu_burger,"Сэндвич", 150, 150, 1))
        listPopular.add(PopularModel(R.drawable.pop_menu_sandwich, "Момо",200,200, 1))
        listPopular.add(PopularModel(R.drawable.pop_menu_momo,"Бургер",175,175, 1))
        listPopular.add(PopularModel(R.drawable.pop_menu_burger,"Сэндвич", 150, 150, 1))
